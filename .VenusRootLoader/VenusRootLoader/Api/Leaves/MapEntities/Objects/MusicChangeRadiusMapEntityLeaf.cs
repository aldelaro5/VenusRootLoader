...
{
    internal MusicChangeRadiusMapEntityLeaf(int gameId, string creatorId, string namedId)
    ...
    internal override void InitializeFromExisting()
    {
        ...
        MusicWhenInRange = new(musicsRegistry.GetByGameId(InternalData[2].Value));
    }
}