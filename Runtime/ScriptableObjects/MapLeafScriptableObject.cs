...
namespace VenusRootLoader.Unity.Runtime.ScriptableObjects
{
    ...
    public sealed class MapLeafScriptableObject : ScriptableObject
    {
        ...
        [SerializeField]
        [HideInInspector]
        public bool DefaultCameraPositionOffsetFromTargetOverrideHasValue;
        ...
        [SerializeField]
        [HideInInspector]
        public bool DefaultCameraAnglesOffsetFromTargetOverrideHasValue;
        ...
        [SerializeField]
        [HideInInspector]
        public bool CameraMovesAroundCircleHasValue;
        ...
        [SerializeField]
        [HideInInspector]
        public bool MapWhoProvidesEntitiesAndDialoguesHasValue;
    ...
    public sealed class MapMusicSelectionCondition
    {
        [SerializeField]
        [HideInInspector]
        public bool RequiredFlagHasValue = true;
