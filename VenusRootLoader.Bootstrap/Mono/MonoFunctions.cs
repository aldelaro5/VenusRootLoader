...
public sealed class MonoFunctions : IMonoFunctions
{
    public void Initialize(HMODULE handle)
    {
        ...
        JitInitVersion =
            NativeLibrary.GetExportDelegate<IMonoFunctions.JitInitVersionFn>(handle, "mono_jit_init_version");
        JitParseOptions =
            NativeLibrary.GetExportDelegate<IMonoFunctions.JitParseOptionsFn>(handle, "mono_jit_parse_options");
        ...
        SetAssembliesPath =
            NativeLibrary.GetExportDelegate<IMonoFunctions.SetAssembliesPathFn>(handle, "mono_set_assemblies_path");
        AssemblyGetrootdir =
            NativeLibrary.GetExportDelegate<IMonoFunctions.AssemblyGetrootdirFn>(handle, "mono_assembly_getrootdir");
        DomainAssemblyOpen =
        ...
        DomainSetConfig =
            NativeLibrary.GetExportDelegate<IMonoFunctions.DomainSetConfigFn>(handle, "mono_domain_set_config");
