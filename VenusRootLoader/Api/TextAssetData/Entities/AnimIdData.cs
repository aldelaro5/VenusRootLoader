...
public sealed class AnimIdData : ITextAssetSerializable
{
    ...
    public List<AnimIdResourcePreload> PreloadResources { get; } = new();
    public bool ShakeOnDrop { get; set; }
    public bool HasDigAnimation { get; set; }
    public bool DoNotOverrideJump { get; set; }
    public bool DontFreezeWhenFalling { get; set; }
    public bool HasNoShadows { get; set; }
    ...
    public float StartingBobRange { get; set; }
    public bool HasIceAnimation { get; set; }
    public bool HasNoFlyAnimation { get; set; }
