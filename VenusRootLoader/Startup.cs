...
internal static class Startup
{
        ...
        BootstrapFunctions bootstrapFunctions)
    {
        ...
        services.AddTransient<IBaseGameCollector, ItemsCollector>();
        services.AddTransient<IBaseGameCollector, EnemiesCollector>();
        services.AddTransient<IBaseGameCollector, RecipesCollector>();
        ...
        services.AddTransient<IBaseGameCollector, MenuTextsCollector>();
        services.AddTransient<IBaseGameCollector, DiscoveriesCollector>();
        services.AddTransient<IBaseGameCollector, RecordsCollector>();
        services.AddTransient<IBaseGameCollector, TermacadePrizesCollector>();
        services.AddTransient<IBaseGameCollector, MusicsCollector>();
        services.AddTransient<IBaseGameCollector, QuestsCollector>();
        services.AddTransient<IBaseGameCollector, RankBonusesCollector>();
        services.AddTransient<IBaseGameCollector, LoreBooksCollector>();
        services.AddTransient<IBaseGameCollector, ActionCommandHelpTextsCollector>();
        services.AddTransient<IBaseGameCollector, SkillsCollector>();
        services.AddTransient<IBaseGameCollector, FishingTextsCollector>();
        services.AddTransient<IBaseGameCollector, SpyCardsTextsCollector>();
        services.AddTransient<IBaseGameCollector, SpyCardsCollector>();
        services.AddTransient<IBaseGameCollector, MedalShopsCollector>();
        services.AddTransient<IBaseGameCollector, MapsCollector>();
