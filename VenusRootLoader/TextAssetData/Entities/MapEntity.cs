...
namespace VenusRootLoader.TextAssetData.Entities;

internal sealed class MapEntity : ITextAssetSerializable
{
    internal NPCControl.NPCType Type { get; set; }
    internal NPCControl.ObjectTypes ObjectType { get; set; }
    internal NPCControl.ActionBehaviors PrimaryBehavior { get; set; }
    internal NPCControl.ActionBehaviors SecondaryBehavior { get; set; }
    internal NPCControl.Interaction NpcInteraction { get; set; }
    internal NPCControl.DeathType DeathType { get; set; }
    internal Vector3 StartingPosition { get; set; }
    internal int AnimIdOrItemId { get; set; }
    internal bool IsFlipped { get; set; }
    internal float CcolHeight { get; set; }
    internal float CcolRadius { get; set; }
    internal float Radius { get; set; }
    internal float Timer { get; set; }
    internal float Speed { get; set; }
    internal float PrimaryActionFrequency { get; set; }
    internal float SecondaryActionFrequency { get; set; }
    internal float SpeedMultiplier { get; set; }
    internal float RadiusLimit { get; set; }
    internal float WanderRadius { get; set; }
    internal float TeleportRadius { get; set; }
    internal bool HaxBoxCol { get; set; }
    internal bool BoxColIsTrigger { get; set; }
    internal Vector3 BoxColSize { get; set; } = Vector3.one;
    internal Vector3 BoxColCenter { get; set; }
    internal float FreezeTime { get; set; }
    internal Vector3 FreezeSize { get; set; } = Vector3.one;
    internal Vector3 FreezeOffset { get; set; } = Vector3.zero;
    internal int EventId { get; set; }
    internal List<int> Requires { get; } = new();
    internal List<int> Limit { get; } = new();
    internal List<int> Data { get; } = new();
    internal List<Vector3> VectorData { get; } = new();
    internal List<Vector3> Dialogues { get; } = new();
    internal Vector3 EulerAngles { get; set; }
    internal List<int> BattleEnemyIds { get; } = new();
    internal Color TagColor { get; set; }
    internal Vector3 EmoticonOffset { get; set; } = Vector3.zero;
    internal int InsideId { get; set; }
    internal List<Vector2> EmoticonFlags { get; } = new();
    internal int SpyDialogueMapId { get; set; }
    internal int RegionalFlagId { get; set; }
    internal float InitialHeight { get; set; }
    internal float BobRange { get; set; }
    internal float BobSpeed { get; set; }
    internal int ActivationFlagId { get; set; }
    internal bool ReturnToHeight { get; set; }
